...
type LiquidConnectButtonProps = {
  onClick?: () => void;
  disabled?: boolean;
  children?: React.ReactNode;
};

export const LiquidConnectButton: React.FC<LiquidConnectButtonProps> = ({ 
  onClick, 
  disabled = false,
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className="group relative inline-block overflow-hidden rounded-full px-8 py-4 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
